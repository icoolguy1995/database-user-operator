...
type DatabaseUserSpec struct {
	// DatabaseType is the type of database (e.g., MongoDB, PostgreSQL, MySQL)
	DatabaseType string `json:"databaseType"`
	// DatabaseName is the name of the database to create the user in
	DatabaseName string `json:"databaseName"`
	// UserName is the name of the User to create the user in
